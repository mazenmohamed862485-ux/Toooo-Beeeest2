import 'dart:async';
  ...
  class FlutterWindowManager {
    ...
    static Future<bool?> addFlags(int flags) async {
      return await _channel.invokeMethod<bool>('addFlags', <String, dynamic>{'flags': flags});
    }

    static Future<bool?> clearFlags(int flags) async {
      return await _channel.invokeMethod<bool>('clearFlags', <String, dynamic>{'flags': flags});
    }
  }
